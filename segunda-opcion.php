    ...
    <div class="navbar navbar-expand-lg landing-navbar px-3 px-md-8">
      ...
      <div class="collapse navbar-collapse landing-nav-menu" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav me-auto">
          ...
          <li class="nav-item">
            <a class="nav-link fw-medium d-flex align-items-center" href="comparacion.php" target="_blank">
              <i class="bx bx-book-open me-2"></i>
              <span>Comparar</span>
              <span class="badge rounded-pill text-white ms-2" style="width: 20px; height: 20px; display: inline-flex; align-items: center; justify-content: center; font-size: 0.7rem;">
                1
              </span>
            </a>
          </li> 
