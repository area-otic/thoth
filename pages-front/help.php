...
<html
  ...
  <head>
    ...
    <meta name="robots" content="noindex" />
      ...
      <title>Demo: Help Center Landing - Front Pages | Sneat - Bootstrap Dashboard PRO</title>
    ...
    <!-- Page CSS -->
    <link rel="stylesheet" href="../assets/pages-front/front-page-help-center.css" />
...
<!-- Sections:Start -->
  ...
  <section class="section-py first-section-pt help-center-header position-relative overflow-hidden">
    <img class="banner-bg-img z-n1" src="../assets/img/header.png" alt="Help center header" />
                ...
                <div class="card-body">
                  <div class="d-flex align-items-center">
                    <div class="avatar avatar-sm flex-shrink-0 me-3">
                      <span class="avatar-initial rounded bg-label-primary"><i class="icon-base bx bx-cart"></i></span>
                    </div>
                    <h5 class="mb-0">Buying</h5>
                  </div>
                  <ul class="list-unstyled my-6">
                    <li class="mb-2">
                      <a href="help-center-article.html" class="text-heading d-flex justify-content-between align-items-center">
            ...
            <div class="col-xl-4 col-sm-6">
              <div class="card">
                <div class="card-body">
                  <div class="d-flex align-items-center">
                    <div class="avatar avatar-sm flex-shrink-0 me-3">
                      <span class="avatar-initial rounded bg-label-primary"><i class="icon-base bx bx-help-circle"></i></span>
                    </div>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <ul class="list-unstyled my-6">
                    ...
                    <li class="mb-2">
                      <a href="help-center-article.html" class="text-heading d-flex justify-content-between align-items-center">
                        <span class="text-truncate me-1"> I’m making a test site - it’s not for a client. Which license do I need? </span>
                        <i class="icon-base bx bx-chevron-right scaleX-n1-rtl text-body-secondary"></i>
                      </a>
                    </li>
                    <li class="mb-2">
            ...
            <div class="col-xl-4 col-sm-6">
              <div class="card">
                <div class="card-body">
                  <div class="d-flex align-items-center">
                    <div class="avatar avatar-sm flex-shrink-0 me-3">
                      <span class="avatar-initial rounded bg-label-primary"><i class="icon-base bx bx-brush"></i></span>
                    </div>
            ...
            <div class="col-xl-4 col-sm-6">
              <div class="card">
                <div class="card-body">
                  <div class="d-flex align-items-center">
                    <div class="avatar avatar-sm flex-shrink-0 me-3">
                      <span class="avatar-initial rounded bg-label-primary"><i class="icon-base bx bx-lock-open"></i></span>
                    </div>
