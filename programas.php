                ...
                <div class="accordion mb-3" id="filterAccordion">
                    ...
                    <div class="accordion-item border-0">
                        ...
                        <div id="filterDuracion" class="accordion-collapse collapse" data-bs-parent="#filterAccordion">
                            <div class="accordion-body pt-0 pb-2 px-3">
                                <div class="form-check mb-2">
                                    <input class="form-check-input filter-checkbox" type="checkbox" value="short" id="duracion-corta" data-filter="duracion">
                                    <label class="form-check-label small" for="duracion-corta">
                                        Programas cortos (hasta 6 meses/1 trimestre)
                                    </label>
                                </div>
                                <div class="form-check mb-2">
                                    <input class="form-check-input filter-checkbox" type="checkbox" value="medium" id="duracion-media" data-filter="duracion">
                                    <label class="form-check-label small" for="duracion-media">
                                        Programas medios (6-12 meses/1-2 trimestres)
                                    </label>
                                </div>
                                <div class="form-check mb-2">
                                    <input class="form-check-input filter-checkbox" type="checkbox" value="long" id="duracion-larga" data-filter="duracion">
                                    <label class="form-check-label small" for="duracion-larga">
                                        Programas largos (1-2 años)
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input filter-checkbox" type="checkbox" value="extended" id="duracion-extendida" data-filter="duracion">
...
<script>
    ...
    async function loadPrograms(page = 1, filters = {}) {
        currentPage = page;
        ...
        try {
            ...
            const response = await fetch(`control/filtrar_programas2.php?${params.toString()}`);
            ...
            programsContainer.innerHTML = `
                <div class="col-12 text-center py-5">
                    <div class="alert alert-danger">
                        Ocurrió un error al cargar los programas. Por favor, inténtalo de nuevo.
                    </div>
                </div>
            `;
        }
    ...
    function updatePaginationControls(total, currentPage) {
        ...
        prevBtn.addEventListener('click', () => {
            if (currentPage > 1) {
                loadPrograms(currentPage - 1, activeFilters);
            }
        });
    ...
    btnSearch.addEventListener('click', () => {
        ...
        if (searchTerm) {
            ...
            // Por ahora solo recargamos con los filtros actuales
            loadPrograms(1, activeFilters);
        }
    });
