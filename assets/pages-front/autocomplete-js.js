! function(e, t) {
    ...
    return function() {
        ...
        function O(e) {
            var t, r, n, o = (t = c((e.version || "").split(".").map(Number), 2), r = t[0], n = t[1], r >= 3 || 2 === r && n >= 4 || 1 === r && n >= 10);
                ...
                viewedObjectIDs: function() {
                    ...
                    t.length > 0 && t.reduce((function(e, t) {
                        ...
                        return [].concat(m(e), m(function(e) {
                            for (var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 20, r = [], n = 0; n < e.objectIDs.length; n += t) r.push(b(b({}, e), {}, {
        ...
        var D = "2.15.0",
            C = "https://cdn.jsdelivr.net/npm/search-insights@".concat(D, "/dist/search-insights.min.js"),
            k = r((function(e) {
        ...
        function x(e) {
            var t = function(e) {
                    return E({
                        onItemsChange: function(e) {
                            ...
                            t.viewedObjectIDs.apply(t, P(r.map((function(e) {
                                return E(E({}, e), {}, {
                                    algoliaSource: N(e.algoliaSource, n.context)
                                })
                            }))))
                        },
                        onSelect: function(e) {
                ...
                o = t.insightsClient,
                c = t.insightsInitParams,
                l = t.onItemsChange,
                s = t.onSelect,
                f = t.onActive,
                p = t.__autocomplete_clickAnalytics,
                m = o;
            if (o || function(e) {
                    ...
                    "string" == typeof r && (m = t[r]), m || (t.AlgoliaAnalyticsObject = r, t[r] || (t[r] = function() {
                        ...
                        try {
                            ...
                            t.async = !0, t.src = C, t.onerror = function() {}, document.body.appendChild(t)
                        } catch (e) {}
                    }(t))
                })), !m) return {};
            c && m("init", E({
                    ...
                    function o(e) {
                        t({
                            algoliaInsightsPlugin: {
                                __algoliaSearchParameters: E(E({}, p ? {
                                    clickAnalytics: !0
                                } : {}), e ? {
                                    userToken: T(e)
                                } : {}),
            ...
            if (o = e, Boolean(null == o ? void 0 : o.execute)) {
                ...
                return se(se({}, e), {}, {
                    requests: e.queries.map((function(r) {
                        return {
                            query: "algolia" === e.requesterId ? se(se({}, r), {}, {
                                params: se(se({}, n), r.params)
                            }) : r,
                            sourceId: t,
        ...
        var De, Ce, ke, xe = null,
            Ne = (De = -1, Ce = -1, ke = void 0, function(e) {
                var t = ++De;
        ...
        function Te(e) {
            ...
            if (f(i), p(o.defaultActiveItemId), !i && !1 === o.openOnFocus) {
                ...
                m("idle"), l(d), s(null !== (y = n.isOpen) && void 0 !== y ? y : o.shouldPanelOpen({
                    state: a.getState()
                }));
            ...
            var g = Oe(Ne(o.getSources(Ie({
                ...
                return Promise.all(e.map((function(e) {
                    ...
                    n && v({
                        algoliaInsightsPlugin: Ie(Ie({}, (null === (r = a.getState().context) || void 0 === r ? void 0 : r.algoliaInsightsPlugin) || {}), {}, {
                            __automaticInsights: n
                        })
                    });
                    return be(t, e, a)
                })).then((function(e) {
        ...
        var Qe = ["props", "refresh", "store"],
            $e = ["inputElement", "formElement", "panelElement"],
            Ke = ["inputElement"],
        ...
        var yt = function(e, t) {
            switch (t.type) {
                ...
                case "setContext":
                    return mt(mt({}, e), {}, {
                        context: mt(mt({}, e.context), t.payload)
                    });
                case "ArrowDown":
                    var r = mt(mt({}, e), {}, {
                        activeItemId: t.payload.hasOwnProperty("nextActiveItemId") ? t.payload.nextActiveItemId : st(1, e.activeItemId, W(e), t.props.defaultActiveItemId)
                    });
                    return mt(mt({}, r), {}, {
                        completion: lt({
                            state: r
                ...
                case "ArrowUp":
                    var n = mt(mt({}, e), {}, {
                        activeItemId: st(-1, e.activeItemId, W(e), t.props.defaultActiveItemId)
                    });
                    return mt(mt({}, n), {}, {
                        completion: lt({
                            state: n
                ...
                case "blur":
                    return t.props.debug ? e : mt(mt({}, e), {}, {
                        isOpen: !1,
                        activeItemId: null
                    });
                case "mouseleave":
        ...
        function Ct(e, t, r) {
            ...
            if ("style" === t)
                ...
                for (t in r) i && r[t] === i[t] || At(e.style, t, r[t]);
        ...
        var Jt, Xt, Yt, Zt, er, tr, rr, nr, or, ir, ur = {},
            ar = [],
            cr = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i,
            lr = Array.isArray;
        ...
        function pr(e, t, r) {
            ...
            if (arguments.length > 2 && (u.children = arguments.length > 3 ? Jt.call(arguments, 2) : r), "function" == typeof e && null != e.defaultProps)
        ...
        function _r(e, t, r) {
            var n, o, i, u, a, c = t.length,
                l = r.length,
                s = l,
                f = 0;
            for (e.__k = [], n = 0; n < c; n++) null != (o = t[n]) && "boolean" != typeof o && "function" != typeof o ? (u = n + f, (o = e.__k[n] = "string" == typeof o || "number" == typeof o || "bigint" == typeof o || o.constructor == String ? mr(null, o, null, null, null) : lr(o) ? mr(vr, {
                children: o
            }, null, null, null) : void 0 === o.constructor && o.__b > 0 ? mr(o.type, o.props, o.key, o.ref ? o.ref : null, o.__v) : o).__ = e, o.__b = e.__b + 1, i = null, -1 !== (a = o.__i = jr(o, r, u, s)) && (s--, (i = r[a]) && (i.__u |= 131072)), null == i || null === i.__v ? (-1 == a && f--, "function" != typeof o.type && (o.__u |= 65536)) : a !== u && (a == u - 1 ? f-- : a == u + 1 ? f++ : (a > u ? f-- : f++, o.__u |= 65536))) : o = e.__k[n] = null;
            if (s)
                for (n = 0; n < l; n++) null != (i = r[n]) && !(131072 & i.__u) && (i.__e == e.__d && (e.__d = dr(i)), kr(i, i))
        }
            ...
            e: if ("style" === t)
                if ("string" == typeof r) e.style.cssText = r;
                    ...
                    if ("string" == typeof n && (e.style.cssText = n = ""), n)
                        for (t in n) r && t in r || Pr(e.style, t, "");
                    if (r)
                        for (t in r) n && r[t] === n[t] || Pr(e.style, t, r[t])
                }
            else if ("o" === t[0] && "n" === t[1]) i = t !== (t = t.replace(/(PointerCapture)$|Capture$/i, "$1")), t = t.toLowerCase() in e || "onFocusOut" === t || "onFocusIn" === t ? t.toLowerCase().slice(2) : t.slice(2), e.l || (e.l = {}), e.l[t + i] = r, r ? n ? r.u = n.u : (r.u = nr, e.addEventListener(t, i ? ir : or, i)) : e.removeEventListener(t, i ? ir : or, i);
            else {
        ...
        function Dr(e, t, r, n, o, i, u, a, c) {
            var l, s, f, p, m, v, y, d = r.props,
                b = t.props,
                g = t.type;
            if ("svg" === g ? o = "http://www.w3.org/2000/svg" : "math" === g ? o = "http://www.w3.org/1998/Math/MathML" : o || (o = "http://www.w3.org/1999/xhtml"), null != i)
                for (l = 0; l < i.length; l++)
                    if ((m = i[l]) && "setAttribute" in m == !!g && (g ? m.localName === g : 3 === m.nodeType)) {
                        e = m, i[l] = null;
                        break
                    } if (null == e) {
            ...
            if (null === g) d === b || a && e.data === b || (e.data = b);
            else {
                if (i = i && Jt.call(e.childNodes), d = r.props || ur, !a && null != i)
                    for (d = {}, l = 0; l < e.attributes.length; l++) d[(m = e.attributes[l]).name] = m.value;
                for (l in d)
                    if (m = d[l], "children" == l);
                    else if ("dangerouslySetInnerHTML" == l) f = m;
                else if (!(l in b)) {
                ...
                if (s) a || f && (s.__html === f.__html || s.__html === e.innerHTML) || (e.innerHTML = s.__html), t.__k = [];
                else if (f && (e.innerHTML = ""), Or(e, lr(p) ? p : [p], t, r, n, "foreignObject" === g ? "http://www.w3.org/1999/xhtml" : o, i, u, i ? i[0] : r.__k && dr(r, 0), a, c), null != i)
        ...
        function kr(e, t, r) {
            ...
            if (n = e.__k)
                for (o = 0; o < n.length; o++) n[o] && kr(n[o], t, r || "function" != typeof e.type);
        ...
        var Br = "__aa-highlight__",
            qr = "__/aa-highlight__";

        function Rr(e) {
            var t = e.highlightedValue.split(Br),
                r = t.shift(),
                n = function() {
        ...
        function Ur(e) {
            ...
            return "string" != typeof o && (o = Tr(t, n) || ""), Rr({
                highlightedValue: o
            })
        }
        ...
        var Hr = {
            ...
            Vr = new RegExp(/\w/i),
            Wr = /&(amp|quot|lt|gt|#39);/g,
            Qr = RegExp(Wr.source);

        function $r(e, t) {
            var r, n, o, i = e[t],
                u = (null === (r = e[t + 1]) || void 0 === r ? void 0 : r.isHighlighted) || !0,
        ...
        function dn(e) {
            ...
            switch (t) {
                ...
                case "end":
                    return {
                        top: u, right: o.document.documentElement.clientWidth - (i.left + i.width)
                    };
                case "full-width":
                    return {
                        top: u, left: 0, right: 0, width: "unset", maxWidth: "unset"
                    };
                case "input-wrapper-width":
                    var a = n.getBoundingClientRect();
                    return {
                        top: u, left: a.left, right: o.document.documentElement.clientWidth - (a.left + a.width), width: "unset", maxWidth: "unset"
                    };
                default:
        ...
        function Un(e) {
            ...
            function j(e) {
                ...
                ! function(e) {
                    ...
                    Nt(n.root, o.getRootProps(On({
                        ...
                        hidden: "stalled" === i.status
                    }), xt(n.loadingIndicator, {
                        hidden: "stalled" !== i.status
                    }), xt(n.clearButton, {
                        hidden: !i.query
                    }), xt(n.detachedSearchButtonQuery, {
                        textContent: i.query
                    }), xt(n.detachedSearchButtonPlaceholder, {
                ...
                function(e, t) {
                    ...
                    if (l.isOpen) {
                        ...
                        var p = l.collections.filter((function(e) {
                                ...
                                return f.createElement("section", {
                                ...
                                }, u.templates.header && f.createElement("div", {
                                    ...
                                    state: l,
                                    html: i
                                })), u.templates.noResults && 0 === a.length ? f.createElement("div", {
                                ...
                                }))), u.templates.footer && f.createElement("div", {
                            ...
                            m = f.createElement(f.Fragment, null, f.createElement("div", {
                                className: o.panelLayout
            ...
            return i((function() {
                ...
                return xt(v.value.core.environment, e),
                    function() {
